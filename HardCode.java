...
public class HardCode extends LinearOpMode
{
    ...
    private double DESIRED_DISTANCE  = 24; // Set in inches
    ...
    private double basePosLeft;
    private double basePosRight;
    private double rotationsLeft = 0.0;
    private double rotationsRight = 0.0;
    ...
    @Override public void runOpMode()
    {
        ...
        leftDrive.setTargetPosition((int)targetRotations-(int)rotationsLeft);
        leftDrive.setTargetPosition((int)targetRotations-(int)rotationsRight);
